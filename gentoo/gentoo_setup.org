...
Refer to [[https://wiki.gentoo.org/wiki/ACCEPT_KEYWORDS][Gentoo::Wiki::ACCEPT_KEYWORDS]] for details.
#+begin_example
  ...
...
Migration from ~visual-studio-code~:
#+BEGIN_EXAMPLE
...
[fn:10] [[https://wiki.gentoo.org/wiki/ALSA][Gentoo::Wiki::Alsa]] 
