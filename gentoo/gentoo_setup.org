...
#+BEGIN_EXAMPLE
  # package.use
  >=app-editors/emacs-24.3 gif gui jpeg png svg tiff xft  ❶
  >=app-emacs/emacs-common-gentoo-1.6-r4 gui  ❶

  emerge -a emacs↲
#+END_EXAMPLE
❶ See [[https://github.com/gentoo/gentoo/commit/d7fbd72efd2cc6096a71ac654e1659f12963dfe3#diff-266e679dd27537cb4847ad05a54c97f3][Migrate from X to gui USE flag.]] for the details of adding the "gui" USE flag.
...
#+BEGIN_EXAMPLE
  ...
  # Revert the previous Git config
...
rust-analyzer needs the sources of the standard library, which Gentoo
doesn't provide as a stand-alone package in their official
repositories. Enable the ~rls~ USE flag of your rust/rust-bin package
can solve this issue.
#+begin_example
  # /etc/portage/package.use

  # rust
  >=dev-lang/rust-1.54.0 ... rls ...  ❸
#+end_example
