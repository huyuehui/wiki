...
* TODO Add "noatime" to "/dev/sdb2" mount options to improve performance?
...
#+BEGIN_EXAMPLE
  ...
  LINGUAS="en"
#+END_EXAMPLE
OPTIONAL: Besides input manually, GENTOO_MIRROR & SYNC can be configured by ~mirrorselect~
#+BEGIN_EXAMPLE
...
From [[https://wiki.gentoo.org/wiki/EFI_stub_kernel#Kernel][Gentoo::Wiki::EFI-stub-kernel]] :
#+BEGIN_EXAMPLE
  ...
  Kernel configuration: Enable EFI sysfs controls
  Firmware Drivers  --->
...
We need efibootmgr to alter the EFI boot manager: ~emerge --ask efibootmgr↲~.
...
Quoted from [[http://www.gentoo.org/doc/en/handbook/handbook-amd64.xml?part=1&chap=8#doc_chap1][Gentoo::Handbook::8a-Filesystem_Information]]:
#+BEGIN_EXAMPLE
...
#+BEGIN_EXAMPLE
  ...
  PARTUUID=080cd663-fb32-4cdd-b9d2-42f5ed5a5f45   /mnt    ntfs    defaults,uid=lucifer,gid=users  0       2
#+END_EXAMPLE
NOTE: Before you mount a ntfs partition, you need ~emerge --ask ntfs3g↲~.
