...
#+end_example
① Refer to [[https://github.com/syl20bnr/spacemacs/issues/4807][Spacemacs::Issue4807]] for details.

② My currently using ~.spacemacs~ file is shown as bellow.
...
#+end_example
My personal modifications are describe as bellow.
#+begin_src emacs-lisp :exports code :eval none :results none
  ;; My .spacemacs changes
  (setq-default
   dotspacemacs-configuration-layers
   '(html
     ...
...
** Missing icons
[[https://github.com/domtronn/all-the-icons.el][all-the-icons]] now requires you to install needed fonts manually.
#+begin_example
...
#+end_example
Use [[https://github.com/tallesairan/FA5PRO/tree/fa6][Font Awesome 6 Pro]] to replace the old version ~fontawesome.ttf~.
