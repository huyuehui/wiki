...
Because of [[https://github.com/dimitri/el-get/commit/32631e33f5ea39bb7aff572a1f2df9d451d54229#diff-8d94ee7843f4ef9f2950f073c9d67c3b][commit 32631e33f5]], el-get can't update org-mode now:
#+BEGIN_EXAMPLE
  ## commit 32631e33f5
  ## ~/.emacs.d/el-get/el-get/recipes/org-mode.rcp
  From:
  :url "git://orgmode.org/org-mode.git"
  To:
  :url "https://code.orgmode.org/bzg/org-mode.git"

  ## We should manually change the remote url in local repo
  cd ~/.emacs.d/el-get/org-mode↲
  git remote set-url origin https://code.orgmode.org/bzg/org-mode.git↲
...
#+END_EXAMPLE
Proxy may speed up this process, see [[file:~/work/wiki/org/gentoo/gentoo_setup.org::*Visual Studio Code][socks5 proxy]] for help.
