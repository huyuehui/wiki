...
Use =ob-go.el= from [[https://github.com/pope/ob-go][ob-go]]
#+BEGIN_SRC sh
  mv ob-go-master.zip ~/.emacs.d
  7z x ob-go-master.zip
#+END_SRC
In your =~/.emacs.d/init.el=, add the following lines:
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/.emacs.d/ob-go-master")
  (require 'ob-go)
#+END_SRC
* Footnotes
